...
public class RandomNumbers {
    ...
    public static int getRandomInt() {
        if(random == null) new RandomNumbers(); // invoke constructor to initialize the object
	...
	public static void main(String[] args){
		Random r = new Random(); // API Random Class generate negative or positive random numbers
